    ...
    try {
        ...
        if (response.ok) {
            ...
            if (data.status) {
                ...
                const userAddress = data.checkoutData.userAddress;
                const cityList = data.checkoutData.cityList;
                const cartItems = data.checkoutData.cartList;
                const deliveryTypes = data.checkoutData.deliveryTypes;
